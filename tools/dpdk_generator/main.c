...
int main(int argc, char *argv[])
{
    ...
    // Initialize mrtom ring
    //struct rte_ring *mrtom_ring = init_mrtom_ring(DEFAULT_FLOW_RING_SIZE);
    

    // start receive and transmit workers
    start_workers(rx_params, &p);
    monitor_workers(rx_params, p.nb_rx_workers, mrtom_params);
