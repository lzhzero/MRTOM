...
#define NUM_FAILS 3
#define PAXOS_BITMASK 	  0b00011111
...
#define PAXOS_P2_MASK 0x7D
				//	  ~0b010
#define PAXOS_PORT3 146
#define PAXOS_IP3 0Xc0a80074
//192.168.0.116
...
**************************************************************/
    ...
    table t_reg_op2 {
        ...
        const entries = {
            ...
            (NOPAXOS_MSG_REPLY,			16w1,		0b00001)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b00010)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b00100)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b01000)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b10000)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b11000)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b10100)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b10010)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b10001)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b01100)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b01010)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b01001)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b00110)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b00101)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b00011)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b11000)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b10100)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b10010)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b10001)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b01100)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b01010)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b01001)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b00110)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b00101)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b00011)  :   respond_to_client();
