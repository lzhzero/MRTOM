...
#define NUM_REPLICA 5
#define NUM_FAILS 3
#define PAXOS_BITMASK 	  0b01111111
#define PAXOS_LEADER_MASK 0b10000000
...
#define PAXOS_PORT1 146
#define PAXOS_IP1 0xc0a80074
//192.168.0.116
#define PAXOS_P1_MASK 0x7E
				//    ~0b001
#define PAXOS_PORT2 144
#define PAXOS_IP2 0Xc0a80075
//192.168.0.117
#define PAXOS_P2_MASK 0x7D
				//	  ~0b010
#define PAXOS_PORT3 160
#define PAXOS_IP3 0Xc0a80076
//192.168.0.118
#define PAXOS_P3_MASK 0x7B
				//	  ~0b100

#define PAXOS_PORT4 162
#define PAXOS_IP4 0Xc0a80072
//192.168.0.114
#define PAXOS_P4_MASK 0x77
				//	  ~0b1000

#define PAXOS_PORT5 176
#define PAXOS_IP5 0Xc0a80073
//192.168.0.115
#define PAXOS_P5_MASK 0x6F
				//	  ~0b10000

#define PAXOS_PORT6 162
#define PAXOS_IP6 0Xc0a80070
//192.168.0.112
#define PAXOS_P6_MASK 0x5F
				//	  ~0b1000

#define PAXOS_PORT7 176
#define PAXOS_IP7 0Xc0a80071
//192.168.0.113
#define PAXOS_P7_MASK 0x3F
				//	  ~0b10000
...
**************************************************************/
    ...
    table t_reg_op2 {
        ...
        const entries = {
            ...
            (NOPAXOS_MSG_REPLY,			16w1,		0b0000001)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0000010)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0000100)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0001000)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0010000)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0100000)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b1000000)  :   respond_to_client();

            (NOPAXOS_MSG_REPLY,			16w1,		0b1100000)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b1010000)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b1001000)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b1000100)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b1000010)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b1000001)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0110000)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0101000)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0100100)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0100010)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0100001)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0011000)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0010100)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0010010)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0010001)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0001100)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0001010)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0001001)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0000110)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0000101)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0000011)  :   respond_to_client();

            (NOPAXOS_MSG_REPLY,			16w1,		0b1110000)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b1101000)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b1100100)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b1100010)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b1100001)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b1011000)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b1010100)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b1010010)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b1010001)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b1001100)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b1001010)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b1001001)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b1000110)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b1000101)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b1000011)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0111000)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0110100)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0110010)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0110001)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0101100)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0101010)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0101001)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0100110)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0100101)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0100011)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0011100)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0011010)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0011001)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0010110)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0010101)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0010011)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0001110)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0001101)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0001011)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w1,		0b0000111)  :   respond_to_client();

            (NOPAXOS_MSG_REPLY,			16w0,		0b1110000)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b1101000)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b1100100)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b1100010)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b1100001)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b1011000)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b1010100)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b1010010)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b1010001)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b1001100)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b1001010)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b1001001)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b1000110)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b1000101)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b1000011)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b0111000)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b0110100)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b0110010)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b0110001)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b0101100)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b0101010)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b0101001)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b0100110)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b0100101)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b0100011)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b0011100)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b0011010)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b0011001)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b0010110)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b0010101)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b0010011)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b0001110)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b0001101)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b0001011)  :   respond_to_client();
            (NOPAXOS_MSG_REPLY,			16w0,		0b0000111)  :   respond_to_client();
...
*****************************************************************/
    ...
    table t_paxos_assign_bm {
        ...
        const entries = {
            ...
            (PAXOS_IP4,		NOPAXOS_MSG_REPLY,		16w0)	: assign_bitmap_reply_follower(PAXOS_P4_MASK + PAXOS_LEADER_MASK);
            (PAXOS_IP5,		NOPAXOS_MSG_REPLY,		16w0)	: assign_bitmap_reply_follower(PAXOS_P5_MASK + PAXOS_LEADER_MASK);
            (PAXOS_IP6,		NOPAXOS_MSG_REPLY,		16w0)	: assign_bitmap_reply_follower(PAXOS_P6_MASK + PAXOS_LEADER_MASK);
            (PAXOS_IP7,		NOPAXOS_MSG_REPLY,		16w0)	: assign_bitmap_reply_follower(PAXOS_P7_MASK + PAXOS_LEADER_MASK);
            ...
            (PAXOS_IP4,		NOPAXOS_MSG_REPLY,		16w1)   : assign_bitmap_reply_leader(PAXOS_P4_MASK);
            (PAXOS_IP5,		NOPAXOS_MSG_REPLY,		16w1)   : assign_bitmap_reply_leader(PAXOS_P5_MASK);
            (PAXOS_IP6,		NOPAXOS_MSG_REPLY,		16w1)   : assign_bitmap_reply_leader(PAXOS_P6_MASK);
            (PAXOS_IP7,		NOPAXOS_MSG_REPLY,		16w1)   : assign_bitmap_reply_leader(PAXOS_P7_MASK);
