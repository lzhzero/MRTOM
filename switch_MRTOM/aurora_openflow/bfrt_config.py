...
#sm111 on 10G port 
bfrt.nopaxos_p4_openflow.pipe.SwitchIngress.forward.add_with_hit(dst_addr=0xe41d2d1e1ec1, port=128)
#sm112 on 10G port 
bfrt.nopaxos_p4_openflow.pipe.SwitchIngress.forward.add_with_hit(dst_addr=0xe41d2d1e1ee1, port=128)
#sm113 on 10G port 
bfrt.nopaxos_p4_openflow.pipe.SwitchIngress.forward.add_with_hit(dst_addr=0xe41d2d1e21a1, port=128)
#sm114 on 10G port 
bfrt.nopaxos_p4_openflow.pipe.SwitchIngress.forward.add_with_hit(dst_addr=0xe41d2d1e1ef1, port=128)
#sm115 on 10G port 
bfrt.nopaxos_p4_openflow.pipe.SwitchIngress.forward.add_with_hit(dst_addr=0xe41d2d1e21e1, port=128)
#sm116 on 10G port 
bfrt.nopaxos_p4_openflow.pipe.SwitchIngress.forward.add_with_hit(dst_addr=0xe41d2d1e2ad1, port=128)
#sm117 on 10G port 
bfrt.nopaxos_p4_openflow.pipe.SwitchIngress.forward.add_with_hit(dst_addr=0xe41d2d1e1eb1, port=128)
#sm118 on 10G port 
bfrt.nopaxos_p4_openflow.pipe.SwitchIngress.forward.add_with_hit(dst_addr=0xe41d2d1e1d51, port=128)
...
bfrt.nopaxos_p4_openflow.pipe.SwitchEgress.mcast_mods.add_with_modify_packet_no_vlan(egress_rid=5, egress_port=152, dstmac= 0xe41d2d1e1ee1, dstip='192.168.100.112')
bfrt.nopaxos_p4_openflow.pipe.SwitchEgress.mcast_mods.add_with_modify_packet_no_vlan(egress_rid=5, egress_port=160, dstmac= 0xe41d2d1e21a1, dstip='192.168.100.113')
bfrt.nopaxos_p4_openflow.pipe.SwitchEgress.mcast_mods.add_with_modify_packet_no_vlan(egress_rid=5, egress_port=168, dstmac= 0xe41d2d1e1ef1, dstip='192.168.100.114')
